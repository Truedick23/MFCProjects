...
// cg2018LFr2DTransDoc.cpp : Ccg2018LFr2DTransDoc 类的实现
//
...
// Ccg2018LFr2DTransDoc

IMPLEMENT_DYNCREATE(Ccg2018LFr2DTransDoc, CDocument)

BEGIN_MESSAGE_MAP(Ccg2018LFr2DTransDoc, CDocument)
END_MESSAGE_MAP()


// Ccg2018LFr2DTransDoc 构造/析构

Ccg2018LFr2DTransDoc::Ccg2018LFr2DTransDoc()
{
	// TODO: 在此添加一次性构造代码
	P1.x =   0;   P1.y =   0;
	P2.x = 200;   P2.y = 200;
	...
	m_spPolygon[2].x = 200;    m_spPolygon[2].y = 300;
	m_spPolygon[3].x = 300;    m_spPolygon[3].y = 200;
	m_spPolygon[4].x = 250;    m_spPolygon[3].y = -150;
	m_spPolygon[5].x =   0;    m_spPolygon[5].y =   0;

	m_polygonVisible = false;
	m_clipPointNumber = 6;
...
BOOL Ccg2018LFr2DTransDoc::OnNewDocument()
{
...
// Ccg2018LFr2DTransDoc 序列化

void Ccg2018LFr2DTransDoc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
		// TODO: 在此添加存储代码
...
// 缩略图的支持
void Ccg2018LFr2DTransDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void Ccg2018LFr2DTransDoc::InitializeSearchContent()
{
...
void Ccg2018LFr2DTransDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
...
// Ccg2018LFr2DTransDoc 诊断

#ifdef _DEBUG
void Ccg2018LFr2DTransDoc::AssertValid() const
{
	CDocument::AssertValid();
}

void Ccg2018LFr2DTransDoc::Dump(CDumpContext& dc) const
{
	CDocument::Dump(dc);
}
#endif //_DEBUG
