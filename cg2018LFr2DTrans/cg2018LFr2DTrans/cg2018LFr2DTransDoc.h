...
// cg2018LFr2DTransDoc.h : Ccg2018LFr2DTransDoc 类的接口
//
...
class Ccg2018LFr2DTransDoc : public CDocument
{
protected: // 仅从序列化创建
	Ccg2018LFr2DTransDoc();
	DECLARE_DYNCREATE(Ccg2018LFr2DTransDoc)
