...
// cg2018DZx2DTransDoc.h : Ccg2018DZx2DTransDoc 类的接口
//
...
class Ccg2018DZx2DTransDoc : public CDocument
{
protected: // 仅从序列化创建
	Ccg2018DZx2DTransDoc();
	DECLARE_DYNCREATE(Ccg2018DZx2DTransDoc)
