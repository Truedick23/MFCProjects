...
// cg2018QB2DTransDoc.h : Ccg2018QB2DTransDoc 类的接口
//
...
class Ccg2018QB2DTransDoc : public CDocument
{
protected: // 仅从序列化创建
	Ccg2018QB2DTransDoc();
	DECLARE_DYNCREATE(Ccg2018QB2DTransDoc)
